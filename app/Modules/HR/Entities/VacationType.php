...
class VacationType extends Model implements TranslatableContract
{
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ...
            ->useLogName('vacationtype')
            ->logOnlyDirty()
            ->dontSubmitEmptyLogs();
    }
    protected static function newFactory()
    {
        return \App\Modules\HR\Database\factories\VacationTypeFactory::new();
    }
