...
class NotificationName extends Model implements TranslatableContract
{
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ...
            ->useLogName('notificationname')
            ->logOnlyDirty()
            ->dontSubmitEmptyLogs();
    }
    protected static function newFactory()
    {
        return \App\Modules\Finance\Database\factories\NotificationNameFactory::new();
    }
