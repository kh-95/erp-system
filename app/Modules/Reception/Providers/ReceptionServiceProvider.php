...
namespace App\Modules\Reception\Providers;

use App\Modules\Reception\Http\Repositories\ReceptionReport\ReceptionReportRepository;
...
use App\Modules\Reception\Http\Repositories\Visit\VisitRepository;
use App\Modules\Reception\Http\Repositories\Visitor\VisitorRepositoryInterface;
use App\Modules\Reception\Http\Repositories\Visitor\VisitorRepository;
...
class ReceptionServiceProvider extends ServiceProvider
{
     ...
     */
    protected $moduleName = 'Reception';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'reception';
    ...
    public function register()
    {
        ...
        $this->app->bind(ReceptionReportRepositoryInterface::class,ReceptionReportRepository::class);
    }
