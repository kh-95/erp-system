 ...
 */
     ...
     */ 
         ...
         *
         * @return \App\Modules\User\Entities\User|null 
         * @static 
         */ 
         ...
         *
         * @return \App\Modules\User\Entities\User 
...
namespace  { 
             ...
             * @static 
             */ 
            public static function customDateFromTo($request, $columnName = 'created_at', $dateFrom = 'created_from', $dateTo = 'created_to')
            {
                                return \Illuminate\Database\Eloquent\Builder::customDateFromTo($request, $columnName, $dateFrom, $dateTo);
            }
